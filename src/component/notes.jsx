...
function ShortLine(props){return(
  <g {...props}>
    <rect x="-150"y="-3" height="6" width="300"/>
  </g>
)}

export default function Notes({note}){
  const [height_of_0, space] = [650, 50]
  ...
  return(
  <div>
    <svg x="0px" y="0px" viewBox="0 0 1512 1512" width="200" height="200">
      <g>
        <GCref />
        <Lines />
        {/* <QuarterNoteUp transform="translate(700,500)"/> */}
        {[1,2,3,4,5,6,7].includes(inner) ? <QuarterNoteDown transform={`translate(700,${height})`}/> : null}
        {/* <ShortLine transform="translate(700,0)"/> */}
      </g>
    </svg>
  </div>
)}
